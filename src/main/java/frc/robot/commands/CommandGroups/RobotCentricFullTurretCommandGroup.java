...
import frc.robot.commands.RobotCentricAimAtHubCommand;
...
public class RobotCentricFullTurretCommandGroup extends ParallelCommandGroup {
    ...
    public RobotCentricFullTurretCommandGroup(
            HoodSubsystem hood,
        ...
        addCommands(
            new RobotCentricAimAtHubCommand(drivetrain, xSupplier, ySupplier),
