...
public final class Constants {
    ...
    public static final class VisionConstants {
        ...
        public static final Transform3d ROBOT_TO_SWERVE_CAMERA = new Transform3d(
                new Translation3d(0.3683, -0.1016, 0.0889),
                new Rotation3d(Math.toRadians(180), Math.toRadians(45), 0)
        );

        public static final Transform3d ROBOT_TO_TURRET_CAMERA = new Transform3d(
                new Translation3d(0.06, -0.3283, 0.16),
                new Rotation3d(Math.toRadians(0), Math.toRadians(45), 90)
        );
