...
public class CompTunerConstants {
    ...
    private static final Distance kFrontRightXPos = Inches.of(11.8);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-11.8);
    ...
    private static final Distance kBackRightXPos = Inches.of(-11.8);
     ...
     */
    public static DevCommandSwerveDrivetrain createDrivetrain() {
        return new DevCommandSwerveDrivetrain(
