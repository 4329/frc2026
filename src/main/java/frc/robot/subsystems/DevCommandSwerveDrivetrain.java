...
import frc.robot.generated.DevTunerConstants.TunerSwerveDrivetrain;
 ...
 */
public class DevCommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem, LoggedSubsystem {
     ...
     */
    public DevCommandSwerveDrivetrain(
    ...
    public LoggableInputs log() {
        ...
        drivetrainLog.pose = state.Pose;
        drivetrainLog.velocityX = MetersPerSecond.of(speeds.vxMetersPerSecond);
        drivetrainLog.velocityY = MetersPerSecond.of(speeds.vyMetersPerSecond);
        drivetrainLog.angularVelocity = RadiansPerSecond.of(speeds.omegaRadiansPerSecond);
        drivetrainLog.gyroAngle = state.Pose.getRotation();

        return drivetrainLog;
    }
